...
[1] "Java Tutorials - Generics - Generic Types." Oracle. Disponível em: [https://docs.oracle.com/javase/tutorial/java/generics/types.html](https://docs.oracle.com/javase/tutorial/java/generics/types.html).
